...
const WarunkrestaurantListTemplate = (restaurant) => `
...
const WarunkdetailTemplate = (detail) => `
...
const WarunkskeletonRestaurant = (count) => {
  let template = '';
...
export {
  WarunkrestaurantListTemplate, WarunkdetailTemplate, WarunkskeletonRestaurant, WarunkskeletonDetail,
};
