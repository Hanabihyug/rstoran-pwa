...
import { WarunkdetailTemplate, WarunkskeletonDetail } from '../templates/data-templates';
...
const WarunkDetail = {
  async render() {
    return `
      <h1 class="detail__title"> Details Warunk</h1>
      <div class="resto__detail m-20">
      <div id="info-detail-skeleton">
      ${WarunkskeletonDetail}
      </div>
      <div id="detailMenu">
      <div id="info-detail">
      </div>
      <div id="likeButtonContainer"></div>
      <h2 class="text-center my-70 secondary">Add Testimoni</h2>
          <div class="form-review my-20">
              <form action="">
                  ...
                  <textarea name="inputReview" id="inputReview" cols="30" rows="5"
                      placeholder="The best Warunkt!"></textarea>
  ...
  async afterRender() {
    ...
    try {
      ...
      detailContainer.innerHTML += WarunkdetailTemplate(data.restaurant);
